...
window = ui.Window("Robohemian: Bukowski", layout, size=(1024, 600), font="BohemianTypewriter 38", default_button_element_size=(5, 2), button_color="black", auto_size_buttons=False, resizable=True, background_color="black")
